...
const certificates = [
  {
    ...
    date: "Feb 2026",
    description: "Participated in a national-level project expo organized by the Department of Electronics and Communication Engineering. Presented an engineering project and competed with teams from various institutions across India.",
    credentialUrl: "",
  ...
  issuer: "100xDevs",
  date: "July 2025",
  description: "Completed a web development cohort focused on building full-stack applications. Learned core concepts of frontend and backend development, worked on real-world projects, and gained practical experience in modern web technologies.",
  credentialUrl: "",
      ...
      >
        ...
        <div style={{ padding: "1.3rem 1.4rem 1.5rem", flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.45rem", marginBottom: "0.75rem" }}>
            ...
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.68rem", color: "rgba(255,255,255,0.3)" }}>
              {cert.date}
            </span>
          </div>
